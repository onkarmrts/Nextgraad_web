...
export default function Navbar() {
  ...
  return (
    <nav className="w-full border-b border-gray-800 bg-[#0B0F19]/80 backdrop-blur-lg sticky top-0 z-50">
      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-4">
        ...
        <div className="hidden md:block">
          ...
          <Link
            href="/internships"
            className="bg-[#FF5A2F] px-5 py-2 rounded-lg text-sm font-medium hover:opacity-90 transition"
          >
            Get Started
          </Link>
