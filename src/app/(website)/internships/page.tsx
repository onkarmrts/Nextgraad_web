...
const DOMAINS = [
  {
    ...
    desc: "Build full-stack apps with modern frameworks and real deployment.",
    tags: ["React", "Node.js", "HTML/CSS", "Git"],
  },
  {
    icon: "🤖",
    title: "Data Science",
    desc: "Work with real datasets, build predictive models, present insights.",
    tags: ["Python", "ML", "Statistics", "Pandas"],
  },
  {
    icon: "🧠",
    title: "Artificial Intelligence",
    desc: "Design AI pipelines, NLP models, and applied ML systems.",
    tags: ["Deep Learning", "NLP", "TensorFlow", "LLMs"],
  },
  {
    icon: "📈",
    title: "Data Analytics",
    desc: "Turn raw data into dashboards and decisions that companies act on.",
    tags: ["SQL", "Power BI", "Excel", "Tableau"],
  },
  {
    icon: "💼",
    title: "Business Analytics",
    desc: "Solve real business problems using data-driven strategic frameworks.",
    tags: ["Strategy", "Excel", "Case Studies", "KPIs"],
  },
  {
    icon: "📊",
    title: "Financial Analyst",
    desc: "Work on P&L models, financial reports, and investment analysis.",
    tags: ["Financial Modeling", "Tally", "MIS", "Excel"],
  },
  {
    icon: "🤝",
    title: "HR Intern",
    desc: "Recruitment pipelines, HR ops, people analytics — real people work.",
    tags: ["Recruitment", "HR Analytics", "Policies", "ATS"],
  },
];
...
const STEPS = [
  {
    ...
    desc: "Complete the enrollment form with your details, domain, and duration. Takes 2 minutes.",
  },
  {
    num: "02",
    icon: "✅",
    title: "Complete Payment",
    desc: "Secure one-time payment via the form. No hidden charges, ever.",
  },
  {
    num: "03",
    icon: "📩",
    title: "Offer Letter — 24 Hours",
    desc: "Your official Nextgraad offer letter is emailed within 24 working hours of enrollment.",
  },
  {
    num: "04",
    icon: "🔐",
    title: "Portal Access Unlocked",
    desc: "Login to your internship portal. Browse projects, pick yours, get started.",
  },
  {
    num: "05",
    icon: "💻",
    title: "Work on Real Projects",
    desc: "Execute your chosen project. Dedicated support whenever you need it.",
  },
  {
    num: "06",
    icon: "🏆",
    title: "Submit & Get Certified",
    desc: "Submit your project → certificate auto-generated and emailed. HireSense AI unlocks.",
  },
];
...
const HOOKS = [
  ...
  {
    icon: "🔓",
    text: "ProfileForge AI + HireSense AI — both free for enrolled interns",
  },
];
...
function TestimonialCard({ t }: { t: (typeof TESTIMONIALS)[0] }) {
  return (
    ...
    >
      ...
      {/* Quote */}
      <p style={{ color: "#94A3B8", fontSize: 14, lineHeight: 1.75, flex: 1 }}>
        "{t.text}"
      </p>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div>
          ...
          <div style={{ color: "#475569", fontSize: 12 }}>
            Recruiter-facing talent intelligence
          </div>
        </div>
        <span
          style={{
        ...
        {[
          {
            ...
            sub: "Experience, skills, connections",
          },
          {
            icon: "💻",
            label: "GitHub Profile",
            sub: "Repos, commit activity, languages",
          },
      ...
      <div
        style={{
          background:
            "linear-gradient(135deg, rgba(37,99,235,.15), rgba(124,58,237,.1))",
          border: "1px solid rgba(37,99,235,.3)",
          borderRadius: 16,
          padding: "20px 24px",
          display: "flex",
      ...
      >
        <div>
          ...
          >
            89<span style={{ fontSize: 18, color: "#475569" }}>/100</span>
          </div>
        </div>
      ...
      >
        ...
        <span style={{ color: "#60A5FA" }}>
          You don't apply — they come to you.
        </span>
      </div>
    </div>
  );
        ...
        >
          ...
          >
            ...
            <span style={{ color: "#BFDBFE", fontSize: 13, fontWeight: 600 }}>
              🇮🇳 &nbsp;10,000+ Students Enrolled Across India
            </span>
          </div>

          {/* Main heading */}
          <h1
            className="fd u2 hero-h1"
            style={{
          ...
          >
            ...
            — <strong style={{ color: "#34D399" }}>completely free</strong> when
            you enroll.
          </p>
          ...
          >
            🚫 Don't pay thousands to get an internship — we don't charge for
            experience.
          </p>

          {/* HERO VIDEO */}
<div className="u3" style={{ marginTop: 20, marginBottom: 35 }}>
  <div style={{
    width: "100%",
    maxWidth: 620,
    margin: "0 auto",
    ...
    background: "#080D1A",
    boxShadow: "0 0 40px rgba(37,99,235,.14)"
  }}>
    <div style={{
      position: "relative",
      paddingBottom: "56.25%",
      ...
      <iframe
  src="https://www.youtube.com/embed/L8hUMmHUt5o?controls=1&rel=0&modestbranding=1"
  title="Nextgraad Internship Intro"
...
/>
  ...
  <p style={{
    ...
    Watch how Nextgraad internships work — real projects, AI tools & recruiter access.
  </p>
</div>
            ...
            >
              <div style={{ textAlign: "left" }}>
                <div style={{ color: "#fff", fontWeight: 700, fontSize: 14 }}>
                  ProfileForge AI + HireSense AI
                </div>
                <div style={{ color: "#475569", fontSize: 12 }}>
                  AI tools worth{" "}
                  <span style={{ textDecoration: "line-through" }}>₹4,498</span>
                </div>
              </div>
              <div
                style={{
              ...
              <div style={{ textAlign: "left" }}>
                <div
                  style={{ color: "#34D399", fontWeight: 800, fontSize: 16 }}
                >
                  FREE
                </div>
                <div style={{ color: "#475569", fontSize: 12 }}>
      ...
      <section
        ref={statsRef}
        style={{ padding: "60px 24px", background: "#06091A" }}
      >
        <div
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 72 }}>
            ...
            >
              Worth{" "}
              <span
                style={{ textDecoration: "line-through", color: "#334155" }}
              >
                ₹5,000
              </span>{" "}
              — You Pay <span className="pt">₹99</span>
            </h2>
            <p style={{ color: "#475569", maxWidth: 520, margin: "0 auto" }}>
              No hidden fees. Everything below is unlocked from enrollment until
              certificate. No renewals.
            </p>
          </div>
          ...
          >
            {INCLUDED.map((item) => (
              <div key={item.title} className="card" style={{ padding: 24 }}>
                ...
                <p style={{ color: "#475569", fontSize: 12, lineHeight: 1.65 }}>
                  {item.desc}
                </p>
                {item.strikePrice && (
                  <div
      ...
      <section
        id="domains"
        className="grid-bg"
        style={{ padding: "100px 24px", background: "#06091A" }}
      >
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 72 }}>
            <p className="label" style={{ marginBottom: 14 }}>
            ...
            >
              7+ Domains.
              <br />
              <span className="gt">One Enrollment.</span>
            </h2>
            <p style={{ color: "#475569", maxWidth: 460, margin: "0 auto" }}>
              Industry-relevant tracks built for what companies actually look
              for. Pick the one that fits your goals.
            </p>
          </div>
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    boxShadow: sel
                      ? "0 0 40px rgba(37,99,235,.25), inset 0 1px 0 rgba(59,130,246,.15)"
                      : "none",
                  ...
                  >
                    ...
                    <div
                      style={{
                        ...
                        height: 18,
                        borderRadius: "50%",
                        border: `2px solid ${sel ? "#2563EB" : "rgba(255,255,255,.15)"}`,
      ...
      <section id="how-it-works" style={{ padding: "100px 24px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 72 }}>
            ...
            >
              Enroll to Certificate —<br />
              <span className="gt">Step by Step</span>
            </h2>
            <p style={{ color: "#475569", maxWidth: 460, margin: "0 auto" }}>
          ...
          >
            {STEPS.map((s, i) => (
              ...
              >
                ...
                <p style={{ color: "#475569", fontSize: 11, lineHeight: 1.65 }}>
                  {s.desc}
                </p>
              </div>
            ))}
      ...
      >
        ...
        >
          ...
          >
            Your Career Starts
            <br />
            <span className="gt">With One Click</span>
          </h2>

          <p style={{ color: "#64748B", fontSize: 18, marginBottom: 10 }}>
            Real projects. Verified certificate. AI tools worth ₹9,498 — all
            yours for ₹99.
          </p>
          <p
            style={{
          ...
          >
            🚫 Don't pay thousands for a dummy internship. We've never believed
            in that.
          </p>
          ...
          <p style={{ color: "#1E293B", fontSize: 12, marginTop: 24 }}>
            One-time payment · No renewals · No hidden fees · Offer letter
      ...
      >
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          >
            ...
            <div>
              <p className="label" style={{ marginBottom: 14 }}>
                Exclusive for Nextgraad Interns
              </p>
              <h2
                className="fd"
                style={{
              ...
              >
                HireSense AI —<br />
                <span className="gt">Recruiters Come to You</span>
              </h2>
              <p
                style={{
                  color: "#64748B",
              ...
              >
                After completing your internship, you unlock{" "}
                <strong style={{ color: "#fff" }}>HireSense AI</strong> —
                Nextgraad's recruiter intelligence platform. Connect your
                GitHub, LinkedIn, and resume. Our AI builds your talent profile
                and scores you.
              </p>
              <p
                style={{
              ...
              >
                Recruiters from 200+ startups and companies browse these
                profiles directly.{" "}
                <strong style={{ color: "#60A5FA" }}>
                  You don't apply — they approach you.
                </strong>
              </p>
              <div
              ...
              >
                {[
                  {
                    icon: "🔗",
                    text: "Connect LinkedIn, GitHub & Resume in one click",
                  },
                  {
                    icon: "📊",
                    text: "AI scores your profile out of 100 based on real skills",
                  },
                  {
                    icon: "🔔",
                    text: "Get notified when recruiters view your profile",
                  },
                  {
                    icon: "🤝",
                    text: "Direct recruiter outreach — no cold applying needed",
                  },
                ].map((item) => (
                  <div
                    key={item.text}
              ...
              >
                ...
                <div>
                  ...
                  >
                    Free for all Nextgraad interns
                  </div>
                  <div style={{ color: "#475569", fontSize: 12 }}>
                    Unlocks automatically after internship completion
                  </div>
                </div>
              </div>
            </div>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          >
            ...
            <div>
              ...
              >
                Most resumes never pass ATS screening.{" "}
                <strong style={{ color: "#fff" }}>ProfileForge AI</strong>{" "}
                analyzes your resume, rewrites it for maximum ATS score, and
                optimizes your LinkedIn profile for recruiter searchability.
              </p>
              <div
                style={{
                  display: "flex",
              ...
              >
                {[
                  {
                    icon: "🎯",
                    text: "AI-powered ATS score optimizer — get past filters",
                  },
                  {
                    icon: "✍️",
                    text: "LinkedIn headline, summary, and skills rewritten by AI",
                  },
                  {
                    icon: "🔑",
                    text: "Keyword analysis matched to your target job roles",
                  },
                  {
                    icon: "📈",
                    text: "Real-time suggestions to improve recruiter visibility",
                  },
                ].map((item) => (
                  <div
                    key={item.text}
              ...
              >
                ...
                <div>
                  <div
                    style={{ color: "#FCD34D", fontWeight: 700, fontSize: 14 }}
                  >
                    Worth ₹1,499 — Free with enrollment
                  </div>
                  <div style={{ color: "#475569", fontSize: 12 }}>
                    Available from day one of your internship
                  </div>
                </div>
              </div>
            </div>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 72 }}>
            ...
            <p style={{ color: "#475569", maxWidth: 480, margin: "0 auto" }}>
              HireSense AI scores and surfaces talent. Recruiters find them.
          ...
          >
            <div style={{ textAlign: "center" }}>
              <div
                className="fd"
                style={{ fontSize: 32, fontWeight: 800, color: "#60A5FA" }}
              >
                85+
              </div>
            ...
            <div style={{ textAlign: "center" }}>
              <div
                className="fd"
                style={{ fontSize: 32, fontWeight: 800, color: "#34D399" }}
              >
                200+
              </div>
              <div style={{ color: "#475569", fontSize: 13 }}>
            ...
            <div style={{ textAlign: "center" }}>
              <div
                className="fd"
                style={{ fontSize: 32, fontWeight: 800, color: "#FCD34D" }}
              >
                4,800+
              </div>
              <div style={{ color: "#475569", fontSize: 13 }}>
                Profiles Viewed by Recruiters
              </div>
            </div>
          </div>
        </div>
      ...
      >
        ...
        <div style={{ maxWidth: 700, margin: "0 auto", position: "relative" }}>
          ...
          <div className="enroll-wrap" style={{ padding: 40 }}>
              ...
              >
                {DOMAINS.map((d) => (
                  <button
                    ...
                    onClick={() =>
                      setSelectedDomain(
                        selectedDomain === d.title ? null : d.title,
                      )
                    }
                    style={{
                      display: "flex",
              ...
              >
                {([1, 2, 3] as Duration[]).map((d) => (
                  ...
                  >
                    ...
                    <div
                      style={{ color: "#475569", fontSize: 12, marginTop: 4 }}
                    >
                      {d === 1 ? "Month" : "Months"}
                    </div>
                  </button>
            ...
            >
              ...
              >
                <div>
                  ...
                  <div
                    style={{ color: "#34D399", fontSize: 11, fontWeight: 600 }}
                  >
                    You save ₹9,498
                  </div>
                </div>
            ...
            >
              No hidden fees. No renewals. Everything above included until you
            ...
            >
              {[
                ...
                <span key={t} style={{ color: "#334155", fontSize: 11 }}>
                  {t}
                </span>
              ))}
            </div>
            ...
            {[
              {
                ...
                a: "Yes. Nextgraad is a registered company. You receive an official offer letter on company letterhead, a real portal login, real projects, and a verifiable certificate — valid for your resume, LinkedIn, and college records.",
              },
              {
                q: "Why is it only ₹99?",
                a: "₹99 is a commitment fee — it ensures only serious students enroll. We don't believe in charging thousands for a certificate. You're paying for commitment, not the experience. The experience is the point.",
              },
              {
                q: "When do I get my offer letter?",
                a: "Your official Nextgraad offer letter is emailed within 24 working hours of enrollment and payment confirmation. Portal access is provided simultaneously.",
              },
              {
                q: "Are the projects real or dummy?",
                a: "Real. Every project in our portal is based on actual industry use cases — not fabricated exercises. You will have something meaningful to show in interviews and on LinkedIn.",
              },
              {
              ...
              <div
                key={i}
                className={`faq-row ${openFaq === i ? "fopen" : ""}`}
              >
                <button
